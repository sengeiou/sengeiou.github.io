...
- 紫色代表的是注册服务和[获取服务](http://sxtdtechs.com/2015/11/15/binder-get-service/)的公共接口/父类；
...
由[Binder系列3—启动ServiceManager](http://sxtdtechs.com/2015/11/07/binder-start-sm/)已介绍其原理，循环在binder_loop()过程，
会调用binder_parse()方法。
...
到此，其他进行便可以获取该服务，使用服务提供的方法，下一篇文章将会讲述[如何获取服务](http://sxtdtechs.com/2015/11/15/binder-get-service/)。
